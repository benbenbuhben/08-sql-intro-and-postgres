...
// Mac:
const conString = 'postgres://localhost:5432/ben_steph';
...
app.get('/new', (request, response) => {
  console.log('Navigated to the new article page');
...
app.get('/articles', (request, response) => {
  console.log('Got data from psql DB and rendered to homepage');
